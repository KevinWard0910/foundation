...
public class LoginBroadcastReceiver extends BroadcastReceiver {
    ...
    public static LoginBroadcastReceiver register() {
        ...
        LocalBroadcastManager.getInstance(BaseFoundation.getContext()).registerReceiver(receiver, intentFilter);
        return receiver;
    }
    ...
    public static void unRegister(LoginBroadcastReceiver receiver) {
        ...
        LocalBroadcastManager.getInstance(BaseFoundation.getContext()).unregisterReceiver(receiver);
    }
    ...
    public static void sentEvent(boolean result) {
        ...
        LocalBroadcastManager.getInstance(BaseFoundation.getContext()).sendBroadcast(intent);
    }
