...
public class BaseRequest<T> extends Request<T> {
     ...
     */
    private static final String PROTOCOL_FORM_CONTENT_TYPE =String.format("application/x-www-form-urlencoded; charset=%s",PROTOCOL_CHARSET);
    private static Map<String,String> mHeaders; //所有的请求用一个头部，只有在登陆之后设置，否则没有头部
    ...
    protected Map<String, String> getParams() throws AuthFailureError {
        LogUtil.d("BaseRequest getParams = " + mParams);
