...
import com.kevin.base.R;
import com.kevin.base.utils.http.HttpCode;
import com.kevin.base.utils.http.HttpConnectException;
import com.kevin.base.utils.http.HttpRequestFactory;
import com.kevin.base.utils.http.IHeaderListener;
import com.kevin.base.utils.http.OnUploadListener;
...
//        params.put("appVersion", AppUtil.getAppVersionName(Foundation.getContext()));
    ...
    private static <T> boolean checkParameters(Object tag, String url, Callback<T> callback) {
        ...
        //检查网络情况
        if (NetworkUtil.isDisConnected(BaseFoundation.getContext())) {
